...
export const mockArticles: Article[] = [
  {
    ...
    title: "Africa's Semiconductor Revolution: Why Ghana and Rwanda Are Betting Big on Chip Manufacturing",
    summary:
  ...
  },
  {
    ...
    title: "Flutterwave's New $3B Valuation Reset Reveals African FinTech's Resilient Appetite for Growth",
    summary:
    ...
    seo: {
      ...
      meta_description: "Flutterwave's new funding round and what it means for African fintech.",
  ...
  },
  {
    ...
    featured_image: "https://images.unsplash.com/photo-1677442d019cecf3e5fa5aeddab77b02ef61208fa?w=1200&q=80",
    ...
    seo: {
      ...
      meta_description: "Kenya launches Africa's first national AI strategy framework.",
      og_image: "https://images.unsplash.com/photo-1677442d019cecf3e5fa5aeddab77b02ef61208fa?w=1200&q=80",
    },
  },
  {
    id: "mock-004",
    slug: "mtn-open-ran-rollout-12-countries-africa",
    title: "MTN's Open RAN Rollout Across 12 Countries Is Quietly Reshaping Telecom Infrastructure in Africa",
    summary:
    ...
    seo: {
      ...
      og_image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1200&q=80",
    },
  },
  {
    id: "mock-005",
    slug: "african-green-bonds-8b-esg-capital-2025",
    title: "African Green Bonds Hit $8B in 2025 as ESG Capital Floods the Continent",
    summary:
    ...
    featured_image: "https://images.unsplash.com/photo-1526304640581-d334cdbbf92e?w=1200&q=80",
    category: ["business"],
    type: "news",
    ...
    seo: {
      ...
      og_image: "https://images.unsplash.com/photo-1526304640581-d334cdbbf92e?w=1200&q=80",
    },
  },
  {
    id: "mock-006",
    slug: "mpesa-18-years-b2b-payments-pivot-kenya",
    title: "M-PESA at 18: How Kenya's Mobile Money Pioneer Is Pivoting to B2B Payments and Merchant Finance",
    summary:
    ...
    seo: {
      ...
      meta_description: "M-PESA pivots to B2B payments and merchant finance at 18 years.",
      og_image: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=1200&q=80",
    },
  },
  {
    id: "mock-007",
    ...
    featured_image: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=1200&q=80",
    ...
    seo: {
      ...
      meta_description: "Nigerian startups training AI models on Yoruba, Igbo, and Hausa.",
      og_image: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=1200&q=80",
    },
  },
  {
    id: "mock-008",
    ...
    seo: {
      ...
      meta_description: "Data analysis shows women-led VC funds outperforming in Africa.",
      og_image: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=1200&q=80",
    },
  },
];

export const mockFeaturedArticle = mockArticles.find((a) => a.is_featured) ?? mockArticles[0];
