...
export function EnrollProductDialog({ account, isOpen, onClose }: EnrollProductDialogProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              required
            />
            <p className="text-xs text-muted-foreground">Enter the product code (e.g., notify, auth, vpn)</p>
          </div>
